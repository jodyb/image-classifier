...
#          following keys:
#            n_images - number of images - len of dict
#            n_dogs_img - number of dog images - ind 3 is true
#            n_notdogs_img - number of NON-dog images - n_images - n_dogs_img
#            n_match - number of matches between pet & classifier labels - idx 2
#            n_correct_dogs - number of correctly classified dog images - idx 3 and idx 4
#            n_correct_notdogs - number of correctly classified NON-dog images - !idx 3 and !idx 4
#            n_correct_breed - number of correctly classified dog breeds  - idx 3 and 2
#            pct_match - percentage of correct matches - / num images
#            pct_correct_dogs - percentage of correctly classified dogs - num dogs
