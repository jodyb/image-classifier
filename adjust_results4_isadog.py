...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, 'r') as f:
        for line in f:
            dog_names_line = [name.strip().lower() for name in line.split(',')]
            for name in dog_names_line:
              if name in dog_names:
               # print("Warning: duplicate dog name detected in dog.txt", name)
               pass
              else:
                dog_names[name] = 1
